...
- The local `pnpm verify:release` gate passes in 252.8 seconds: 86 Vitest files /
  665 tests, 91.81% statements/lines, 88.75% branches, 93.45% functions, both deterministic
