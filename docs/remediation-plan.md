...
- The local `pnpm verify:release` gate passes in 258.2 seconds: 87 Vitest files /
  667 tests, 91.84% statements/lines, 88.78% branches, 93.39% functions, both deterministic
